...
object ButtonTemplates {
    ...
    val categories: List<ButtonTemplateCategory> = listOf(
        ...
        ButtonTemplateCategory("Window", listOf(
            ButtonTemplate("Fullscreen", ButtonActionType.Signal, "FULLSCREEN"),
            ButtonTemplate("Borderless", ButtonActionType.Signal, "BORDERLESS_FS"),
        ...
        ButtonTemplateCategory("Display", listOf(
            ButtonTemplate("Mirror", ButtonActionType.Signal, "MIRROR"),
            ButtonTemplate("Mirror + WM", ButtonActionType.Signal, "MIRROR_WM"),
            ButtonTemplate("Watermark", ButtonActionType.Signal, "WATERMARK"),
            ButtonTemplate("Capture", ButtonActionType.Signal, "CAPTURE"),
